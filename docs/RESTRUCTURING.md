...
- [x] **5.2 Dead/duplicate source removal** (code-health priority 3).
  ...
  > packet-source conditionals and the three residue files this list
  > once named are the ninth slice below; the peer-to-peer whisper
  > path is the seventh.)
  ...
  - Owner: the build (nothing deleted was compiled, so R1 held at each
    ...
    **R15** for the ninth slice - the five macros as tokens under
    `Client/Packet` at 0, and in the rest of the tree at 364.
