...
- [x] **5.3 TextSystem stub retirement.** Split `TextService.cpp`'s pure
  ...
  > is removed. The rich-help parser still needs migration.
  ...
  > remaining rich-help wrapping loop are still open.
