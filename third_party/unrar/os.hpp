...
// OpenDarkEden: keep ALLOW_MISALIGNED undefined. The optimized branches
// dereference misaligned integer pointers, which is undefined in C++ even
// when the CPU accepts it. The existing portable branches preserve archive
// bytes and allow UBSan alignment checks to remain enabled. See README.md.
