...
/*
	m_STR[ATTR_CURRENT] = min(m_STR[ATTR_CURRENT],m_STR[ATTR_MAX]);
	m_STR[ATTR_BASIC] = min(m_STR[ATTR_BASIC],m_STR[ATTR_MAX]);
	m_DEX[ATTR_CURRENT] = min(m_DEX[ATTR_CURRENT],m_DEX[ATTR_MAX]);
	m_DEX[ATTR_BASIC] = min(m_DEX[ATTR_BASIC],m_DEX[ATTR_MAX]);
	m_INT[ATTR_CURRENT] = min(m_INT[ATTR_CURRENT],m_INT[ATTR_MAX]);
	m_INT[ATTR_BASIC] = min(m_INT[ATTR_BASIC],m_INT[ATTR_MAX]);
*/
