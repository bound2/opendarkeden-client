...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_LC_REGISTER_PLAYER_ERROR; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_LC_REGISTER_PLAYER_ERROR; }
