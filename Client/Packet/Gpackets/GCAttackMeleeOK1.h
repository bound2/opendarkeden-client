...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_ATTACK_MELEE_OK_1; }
	...
	PacketSize_t getPacketSize () const { return szObjectID + ModifyInfo::getPacketSize(); }
		...
		// get packet's name
		std::string getPacketName () const { return "GCAttackMeleeOK1"; }
...
public :
	...
	// create packet
	Packet * createPacket () { return new GCAttackMeleeOK1(); }
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_ATTACK_MELEE_OK_1; }
