...
public:
	...
	PacketID_t getPacketID() const noexcept { return PACKET_GC_PARTY_JOINED; }
...
public:
	...
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_PARTY_JOINED; }
	PacketSize_t getPacketMaxSize() const noexcept { return szBYTE + PARTY_MEMBER_INFO_MAX_SIZE * 6; }
};
