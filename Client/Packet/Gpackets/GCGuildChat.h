...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_GUILD_CHAT; }
	...
	// get packet name
	std::string getPacketName() const { return "GCGuildChat"; }
	...
	void setType( BYTE type ) noexcept { m_Type = type; }

	// get/set sender
	std::string getSendGuildName() const { return m_SendGuildName; }
	void setSendGuildName( const std::string& sender ) { m_SendGuildName = sender; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_GUILD_CHAT; }
