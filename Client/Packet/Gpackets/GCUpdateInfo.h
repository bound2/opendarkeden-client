...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_UPDATE_INFO; }
...
public :
	...
	bool hasMotorcycle() const noexcept { return m_hasMotorcycle; }
	...
	// get/set # of NPC
	uint getNPCCount() const noexcept { return m_nNPCs; }
	...
	// get/set # of monster
	uint getMonsterCount() const noexcept { return m_nMonsters; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_UPDATE_INFO; }
