...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_SHOP_SOLD; }
	
	// get packet's body size
	PacketSize_t getPacketSize () const noexcept { return szObjectID + szShopVersion + szShopRackType + szBYTE;}
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_SHOP_SOLD; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static GCShopSoldPacketMaxSize 를 정의, 리턴하라.
	PacketSize_t getPacketMaxSize () const noexcept { return szObjectID + szShopVersion + szShopRackType + szBYTE; }
