...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_GET_OFF_MOTORCYCLE; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_GET_OFF_MOTORCYCLE; }
