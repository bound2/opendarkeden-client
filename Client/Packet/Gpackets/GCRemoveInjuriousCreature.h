...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_REMOVE_INJURIOUS_CREATURE; }
...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_REMOVE_INJURIOUS_CREATURE; }
