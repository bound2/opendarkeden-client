...
public:
	...
	std::string getPacketName() const { return "GCShopBuyOK"; }
...
public:
	...
	ItemNum_t getItemNum(void) const noexcept { return m_ItemNum;}
...
public:
	...
	std::string getPacketName() const { return "GCShopBuyOK"; }
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_SHOP_BUY_OK; }
