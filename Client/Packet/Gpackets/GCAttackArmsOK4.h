...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_ATTACK_ARMS_OK_4; }
	
	// get packet's body size
	// 최적화시, 미리 계산된 정수를 사용한다.
//	PacketSize_t getPacketSize () const throw () { return szObjectID + szObjectID + szbool; }
	PacketSize_t getPacketSize () const noexcept { return szSkillType + szObjectID; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_ATTACK_ARMS_OK_4; }

	// get Packet Max Size
	PacketSize_t getPacketMaxSize () const noexcept { return szSkillType+szObjectID; }
