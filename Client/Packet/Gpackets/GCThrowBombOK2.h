...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_THROW_BOMB_OK_2; }
	...
	PacketSize_t getPacketSize () const { return szObjectID + szCoord*2 + szDir + szItemType
		...
		// get packet's name
		std::string getPacketName () const { return "GCThrowBombOK2"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_THROW_BOMB_OK_2; }
