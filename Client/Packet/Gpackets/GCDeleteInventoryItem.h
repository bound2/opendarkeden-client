...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_DELETE_INVENTORY_ITEM; }
	...
	{ 
		...
		// get packet name
		std::string getPacketName () const { return "GCDeleteInventoryItem"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_DELETE_INVENTORY_ITEM; }
