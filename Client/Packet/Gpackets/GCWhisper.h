...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_WHISPER; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_WHISPER; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static GCWhisperPacketMaxSize 를 정의, 리턴하라.
	PacketSize_t getPacketMaxSize() const noexcept { return szBYTE + 10 + szuint + szBYTE + 128 + szBYTE; }
