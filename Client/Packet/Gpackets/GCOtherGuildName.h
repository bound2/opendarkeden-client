...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_OTHER_GUILD_NAME; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_OTHER_GUILD_NAME; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static GCOtherGuildNamePacketMaxSize 를 정의, 리턴하라.
	PacketSize_t getPacketMaxSize() const noexcept { return szObjectID + szGuildID + szBYTE + 30; }
