...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_KNOCKS_TARGET_BACK_OK_1; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_KNOCKS_TARGET_BACK_OK_1; }
