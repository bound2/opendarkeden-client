...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_SKILL_TO_TILE_OK_6; }
	...
	// get orign x, y
	Coord_t getOrgX() const noexcept { return m_OrgX;}
	Coord_t getOrgY() const noexcept { return m_OrgY;}
	// set origin x, y
	...
	// get / set Range
	Range_t getRange() const noexcept { return m_Range; }
	void setRange(Range_t r) noexcept { m_Range = r; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_SKILL_TO_TILE_OK_6; }
