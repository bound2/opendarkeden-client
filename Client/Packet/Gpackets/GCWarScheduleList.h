...
typedef std::list<WarScheduleInfo*> 			WarScheduleInfoList;
...
public:
	...
	PacketID_t getPacketID() const noexcept { return PACKET_GC_WAR_SCHEDULE_LIST; }
...
public :
	...
	std::string getPacketName() const { return "GCWarScheduleList"; }
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_WAR_SCHEDULE_LIST; }
