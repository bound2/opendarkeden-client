...
public:
	...
	BYTE	getGuildType()	const noexcept { return m_Type-1; }
	void	setGuildType( BYTE Type ) noexcept { m_Type = Type; }
	...
	const string& getGuildMaster() const noexcept { return m_MasterName; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_UNION_OFFER_LIST;}
...
#endif
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_UNION_OFFER_LIST; }
