...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_DELETE_AND_PICKUP_OK; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_DELETE_AND_PICKUP_OK; }
