...
public:
	void read(SocketInputStream & iStream);
	void write(SocketOutputStream & oStream) const;
	PacketID_t getPacketID() const noexcept { return PACKET_GC_SMS_ADDRESS_LIST; }
...
#endif
public:
	std::vector<AddressUnit*>& getAddresses() { return m_Addresses; }
...
public:
	...
	string getPacketName() const { return "GCSMSAddressList"; }
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_SMS_ADDRESS_LIST; }
