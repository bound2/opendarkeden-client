...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_KNOCKS_TARGET_BACK_OK_2; }
	...
	PacketSize_t getPacketSize () const { return szSkillType + szCoord*2 + szDir + szObjectID + ModifyInfo::getPacketSize(); }
		...
		// get packet's name
		std::string getPacketName () const { return "GCKnocksTargetBackOK2"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_KNOCKS_TARGET_BACK_OK_2; }
