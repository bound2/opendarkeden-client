...
public :
	...
	// get / set ListNumber
	BYTE getChangedItemListNum() const noexcept { return m_ChangedItemListNum; }
	void setChangedItemListNum( BYTE ListNum ) noexcept { m_ChangedItemListNum = ListNum; }
...
protected:
	...
	std::list<ObjectID_t> m_ChangedItemList;		// 변경될 Item object id
	std::list<ItemNum_t> m_ChangedItemNumList;	// 변경될 Item object id의 변경 수량.
