...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_GUILD_MEMBER_LIST; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_GUILD_MEMBER_LIST; }
