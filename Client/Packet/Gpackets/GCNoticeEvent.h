...
enum 
{
	...
	NOTICE_EVENT_WELCOME_MESSAGE,				// 캐릭터 처음 생성해서 보여주는 메시지
	NOTICE_EVENT_MEET_GRANDMA,					// 할머니 대화
    NOTICE_EVENT_MEET_FISHSHOP_MASTER,			// 생선아저씨 대화

    NOTICE_EVENT_START_QUEST_ENDING,			// 퀘스트 엔딩 시작
	NOTICE_EVENT_RESULT_LOTTERY,				// 복권 결과

	NOTICE_EVENT_RUN_HORN,						// 돼지 정령 사기쳐서 띄우기
	...
	NOTICE_EVENT_LOGIN_JUST_NOW,                // 방금 로그인했습니다. -_-
	...
	NOTICE_EVENT_LEVEL_WAR_OVER,				// 레벨전쟁 끝났다-0-
...
public:
	...
	PacketID_t getPacketID() const noexcept { return PACKET_GC_NOTICE_EVENT; }
...
public:
	...
	std::string getPacketName() const { return "GCNoticeEvent"; }
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_NOTICE_EVENT; }
