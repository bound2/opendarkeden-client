...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_REGEN_ZONE_STATUS; }
	
	// get packet's body size
	PacketSize_t getPacketSize() const noexcept { return szBYTE * 8; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_REGEN_ZONE_STATUS; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static GCRegenZoneStatusPacketMaxSize 를 정의, 리턴하라.
	PacketSize_t getPacketMaxSize() const noexcept { return szBYTE * 8; } 
};
