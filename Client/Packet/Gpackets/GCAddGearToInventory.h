...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_ADD_GEAR_TO_INVENTORY; }
	
	// get packet's body size
	// *OPTIMIZATION HINT*
	// const static GCAddGearToInventoryPacketSize 를 정의해서 리턴하라.
	PacketSize_t getPacketSize () const noexcept { return szSlotID + szCoordInven + szCoordInven; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_ADD_GEAR_TO_INVENTORY; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static GCAddGearToInventoryPacketSize 를 정의해서 리턴하라.
	PacketSize_t getPacketMaxSize () const noexcept { return szSlotID + szCoordInven + szCoordInven; }
