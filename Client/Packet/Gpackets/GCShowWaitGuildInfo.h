...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_SHOW_WAIT_GUILD_INFO; }
	...
	const std::string& getGuildMaster() const noexcept { return m_GuildMaster; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_SHOW_WAIT_GUILD_INFO; }
