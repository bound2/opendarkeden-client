...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_ATTACK_MELEE_OK_3; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_ATTACK_MELEE_OK_3; }
