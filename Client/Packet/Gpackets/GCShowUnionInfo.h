...
struct SingleGuildInfo
{
	...
	// get/set Guild State
	GuildState_t getGuildState() const noexcept { return m_GuildState; }
	void setGuildState( GuildState_t GuildState ) noexcept { m_GuildState = GuildState; }

	// get/set Guild Master
	const string& getGuildMaster() const noexcept { return m_GuildMaster; }
	...
	// get/set Guild Intro
	const string& getGuildIntro() const noexcept { return m_GuildIntro; }
	void setGuildIntro( const string& GuildIntro ) { m_GuildIntro = GuildIntro; }

	// get/set Guild Join Fee
	Gold_t getJoinFee() const noexcept { return m_JoinFee; }
	void setJoinFee( Gold_t JoinFee ) noexcept { m_JoinFee = JoinFee; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_GC_SHOW_UNION_INFO; }
	...
	SingleGuildInfo&	getMasterGuildInfo() noexcept	{ return m_MasterGuildInfo; }
	...
	SingleGuildInfo* popFrontUnionGuildInfoList()
	{
		if ( !m_GuildList.empty() )
		{
			SingleGuildInfo* pGuildUnionInfo = m_GuildList.front();
			m_GuildList.pop_front();
			return pGuildUnionInfo;
		}
		return NULL;
	}
...
private :
	...
	std::list<SingleGuildInfo*>	m_GuildList;
};
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_GC_SHOW_UNION_INFO; }
