...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_RIDE_MOTORCYCLE_OK; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_RIDE_MOTORCYCLE_OK; }
