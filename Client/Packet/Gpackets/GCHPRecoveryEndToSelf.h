...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_HP_RECOVERY_END_TO_SELF; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_HP_RECOVERY_END_TO_SELF; }
