...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_GC_CROSS_COUNTER_OK_2; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_GC_CROSS_COUNTER_OK_2; }
