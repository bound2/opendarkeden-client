...
public :
	...
	PacketSize_t getSize () const noexcept { return szBYTE + szWORD * m_ListNum * 2; }
	static PacketSize_t getMaxSize() noexcept { return 255;}
	...
	// ClearList
	void clearList() noexcept { m_EList.clear(); m_ListNum = 0; }
