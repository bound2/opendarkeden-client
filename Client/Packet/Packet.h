...
public :
	...
	enum
	{
			...
			PACKET_CG_EXCHANGE_LIST,
			PACKET_CG_EXCHANGE_CREATE_LISTING,
			PACKET_CG_EXCHANGE_CANCEL_LISTING,
			PACKET_CG_EXCHANGE_BUY,
			PACKET_CG_EXCHANGE_CLAIM,
			PACKET_CG_EXCHANGE_MY_LISTINGS,
			PACKET_CG_EXCHANGE_ORDERS,
			PACKET_CG_EXCHANGE_BALANCE,
			PACKET_GC_EXCHANGE_LIST,
			PACKET_GC_EXCHANGE_CREATE_LISTING,
			PACKET_GC_EXCHANGE_CANCEL_LISTING,
			PACKET_GC_EXCHANGE_BUY,
			PACKET_GC_EXCHANGE_CLAIM_LIST,
			PACKET_GC_EXCHANGE_CLAIM_RESULT,
			PACKET_GC_EXCHANGE_MY_LISTINGS,
			PACKET_GC_EXCHANGE_ORDERS,
			PACKET_GC_EXCHANGE_BALANCE,
