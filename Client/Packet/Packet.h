...
public :
	...
	enum
	{
			...
			PACKET_CG_EXCHANGE_CREATE_LISTING,	//   487
			PACKET_CG_EXCHANGE_CANCEL_LISTING,	//   488
			PACKET_CG_EXCHANGE_BUY,			//   489
			PACKET_CG_EXCHANGE_CLAIM,		//   490
			PACKET_CG_EXCHANGE_MY_LISTINGS,	//   491
			PACKET_CG_EXCHANGE_ORDERS,		//   492
			PACKET_CG_EXCHANGE_BALANCE,		//   493
			PACKET_GC_EXCHANGE_LIST,		//   494
			PACKET_GC_EXCHANGE_CREATE_LISTING,	//   495
			PACKET_GC_EXCHANGE_CANCEL_LISTING,	//   496
			PACKET_GC_EXCHANGE_BUY,		//   497
			PACKET_GC_EXCHANGE_CLAIM_LIST,		//   498
			PACKET_GC_EXCHANGE_CLAIM_RESULT,	//   499
			PACKET_GC_EXCHANGE_MY_LISTINGS,	//   500
			PACKET_GC_EXCHANGE_ORDERS,		//   501
			PACKET_GC_EXCHANGE_BALANCE,		//   502
