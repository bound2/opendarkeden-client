...
public:
	PCType getPCType () const noexcept { return PC_VAMPIRE; }
...
public:
	...
	Color_t getBatColor () const noexcept { return m_Colors[VAMPIRE_COLOR_BAT]; }
	void setBatColor (Color_t batColor) noexcept { m_Colors[VAMPIRE_COLOR_BAT] = batColor; }

	Color_t getSkinColor () const noexcept { return m_Colors[VAMPIRE_COLOR_SKIN]; }
	void setSkinColor (Color_t skinColor) noexcept { m_Colors[VAMPIRE_COLOR_SKIN] = skinColor; }

	ItemType_t getCoatType() const noexcept { return m_CoatType; }
    void setCoatType(ItemType_t CoatType) noexcept { m_CoatType = CoatType; }

	Color_t getCoatColor (ColorType colorType = MAIN_COLOR) const noexcept { return m_Colors[VAMPIRE_COLOR_COAT1 + (int)colorType]; }
	void setCoatColor (Color_t coatColor, ColorType colorType = MAIN_COLOR) noexcept { m_Colors[VAMPIRE_COLOR_COAT1 + (int)colorType] = coatColor; }
	...
	Shape_t getShape() const noexcept { return m_Shape; }
	void setShape(Shape_t Shape)  noexcept { m_Shape = Shape; }
