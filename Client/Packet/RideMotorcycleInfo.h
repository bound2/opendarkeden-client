...
public:
	...
	void clearList() noexcept { m_RideMotorcycleSlotInfoList.clear(); m_ListNum = 0; }
...
private:
	...
	std::list<OptionType_t> 	m_OptionType; // motorcycle option type
	BYTE         		m_ListNum;    // number of item in motorcycle inventory

	// actual item info in motorcycle inventory
	std::list<RideMotorcycleSlotInfo*> m_RideMotorcycleSlotInfoList;
