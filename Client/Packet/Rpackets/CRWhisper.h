...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_CR_WHISPER; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_CR_WHISPER; }

	// get packet's max body size
	// *OPTIMIZATION HINT*
	// const static CRWhisperPacketMaxSize 를 정의, 리턴하라.
	PacketSize_t getPacketMaxSize () const noexcept { return szBYTE + 10 + szBYTE + 10 + szBYTE + 32768 + szBYTE + szBYTE; }
