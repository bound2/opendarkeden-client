...
const std::string PCType2String [] = 
{
	"PC_SLAYER",
	"PC_VAMPIRE",
	"PC_OUSTERS"
...
const std::string WeaponType2String[] = 
{ 
	"WEAPON_NONE",
	"WEAPON_SWORD",
	"WEAPON_BLADE",
...
const std::string VampireCoatType2String[] = 
{ 
	"VAMPIRE_COAT_BASIC" , 
	"VAMPIRE_COAT1" , 
	"VAMPIRE_COAT2" ,
...
const std::string OustersCoatType2String[] = 
{ 
	"OUSTERS_COAT_BASIC" , 
	"OUSTERS_COAT1" , 
	"OUSTERS_COAT2" ,
...
const std::string OustersArmType2String[] =
{
...
const std::string OustersSylphType2String[] =
{
	"OUSTERS_SYLPH_OFF",
	"OUSTERS_SYLPH_ON",
	"OUSTERS_SYLPH_MAX"
...
const std::string HairStyle2String [] = 
{
	"HAIR_STYLE1" ,
	"HAIR_STYLE2" ,
	"HAIR_STYLE3"
...
const std::string SkillDomain2String [] = 
{
	"SKILL_DOMAIN_BLADE",
	"SKILL_DOMAIN_SWORD",
	"SKILL_DOMAIN_GUN",
