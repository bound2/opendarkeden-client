...
public:
	...
	Color_t getCoatColor () const noexcept { return m_Colors[OUSTERS_COLOR_COAT]; }
	void setCoatColor (Color_t coatColor) noexcept { m_Colors[OUSTERS_COLOR_COAT] = coatColor; }

	Color_t getHairColor () const noexcept { return m_Colors[OUSTERS_COLOR_HAIR]; }
	void setHairColor (Color_t hairColor) noexcept { m_Colors[OUSTERS_COLOR_HAIR] = hairColor; }

	Color_t getArmColor () const noexcept { return m_Colors[OUSTERS_COLOR_ARM]; }
	void setArmColor (Color_t armColor) noexcept { m_Colors[OUSTERS_COLOR_ARM] = armColor; }

	Color_t getBootsColor () const noexcept { return m_Colors[OUSTERS_COLOR_BOOTS]; }
	void setBootsColor (Color_t bootsColor) noexcept { m_Colors[OUSTERS_COLOR_BOOTS] = bootsColor; }
	...
	OustersSylphType getSylphType() const noexcept { return m_SylphType; }
    void setSylphType(OustersSylphType SylphType) noexcept { m_SylphType = SylphType; }
