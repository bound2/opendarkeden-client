...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_CG_DISPLAY_ITEM; }
	
	// get packet's body size
	PacketSize_t getPacketSize() const noexcept { return szCoordInven + szCoordInven + szObjectID + szGold + szBYTE; }

	// get packet name
	string getPacketName() const { return "CGDisplayItem"; }
...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_CG_DISPLAY_ITEM; }

	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const noexcept { return szCoordInven + szCoordInven + szObjectID + szGold + szBYTE; }
};
