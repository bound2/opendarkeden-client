...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_CG_REGIST_GUILD; }
	...
	// get/set GuildIntro
	std::string getGuildIntro() const { return m_GuildIntro; }
...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_CG_REGIST_GUILD; }

	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const noexcept { return szBYTE + 30 + szBYTE + 256; }
};
