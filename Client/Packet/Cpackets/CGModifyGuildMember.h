...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_CG_MODIFY_GUILD_MEMBER; }
...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_CG_MODIFY_GUILD_MEMBER; }
