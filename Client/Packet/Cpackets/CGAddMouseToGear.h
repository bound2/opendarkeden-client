...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_CG_ADD_MOUSE_TO_GEAR; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_CG_ADD_MOUSE_TO_GEAR; }
