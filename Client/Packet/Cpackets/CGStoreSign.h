...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return PACKET_CG_STORE_SIGN; }
...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_CG_STORE_SIGN; }

	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const noexcept { return szBYTE + 80; }
};
