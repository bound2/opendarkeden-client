...
public:
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_CG_ENCODE_KEY; }
...
public:
	...
	// get/set key
	WORD getEncryptKey () const noexcept { return m_EncryptKey; }

	WORD getHashKey () const noexcept { return m_HashKey; }

	void setEncryptKey ( WORD key ) noexcept { m_EncryptKey = key; }

	void setHashKey ( WORD key ) noexcept { m_HashKey = key; }
...
public:
	...
	// get packet id
	PacketID_t getPacketID() const noexcept { return Packet::PACKET_CG_ENCODE_KEY; }

	// get packet's max body size
	PacketSize_t getPacketMaxSize() const noexcept { return szWORD + szWORD;  }
