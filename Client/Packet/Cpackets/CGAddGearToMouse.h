...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return PACKET_CG_ADD_GEAR_TO_MOUSE; }
	
	// get packet's body size
	// *OPTIMIZATION HINT*
	// const static CGAddGearToMousePacketSize 를 정의해서 리턴하라.
...
public :
	...
	// get packet id
	PacketID_t getPacketID () const noexcept { return Packet::PACKET_CG_ADD_GEAR_TO_MOUSE; }
