...
public:
    ...
    void setLevel (Level_t Level) noexcept { m_Level = Level; }
	...
	void setBatColor (Color_t batColor) noexcept { m_BatColor = batColor; }
	...
	void setMasterEffectColor (BYTE color) noexcept { m_MasterEffectColor = color; }
	...
	Silver_t getSilverDamage() const noexcept { return m_SilverDamage; }
	void setSilverDamage(Silver_t SilverDamage ) noexcept { m_SilverDamage = SilverDamage; }
