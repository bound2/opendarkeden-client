//--------------------------------------------------------------------------------
// 
// Filename    : RequestClientPacketFactoryManager.cpp 
// Written By  : Reiot
// 
//--------------------------------------------------------------------------------
...
#include "RequestClientPacketFactoryManager.h"
...
std::string RequestClientPacketFactoryManager::toString () const
{
	...
	msg << "RequestClientPacketFactoryManager(\n";
...
RequestClientPacketFactoryManager * g_pRequestClientPacketFactoryManager = NULL;
